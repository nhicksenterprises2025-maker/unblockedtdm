...
const testFiles = [
  ...
  'scripts/test-launcher-archive-integrity.mjs',
  ...
  'scripts/test-2.5.0-build1-repair.mjs',
  'scripts/test-2.6.0-progression-brand.mjs',
  'scripts/test-2.6.0-ai.mjs',
  'scripts/test-2.6.0-systems.mjs',
  'scripts/test-2.6.0-interface-maps.mjs',
