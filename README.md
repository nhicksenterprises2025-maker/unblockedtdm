...
**Build 1.6 — Version 1**  
Phase: **Front End / Main Menu / Settings / Keybinds**

Build 1.6 completes the first real game front end: a functional main menu, persistent settings outside and inside matches, control rebinding, exact Weapon Info, improved loadout navigation and a structural fix for UI/gameplay input conflicts.
